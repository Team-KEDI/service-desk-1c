...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ИмяТекущегоСтатуса <> "Решено" И ИмяТекущегоСтатуса <> "Закрыто" И ИмяТекущегоСтатуса <> "В работе" И ИмяТекущегоСтатуса <> "Возврат в работу" Тогда
